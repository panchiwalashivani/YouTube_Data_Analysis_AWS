...
aws s3 cp . s3://youtube-data-analysis-raw-useast1/youtube/raw_statistics_reference_data/ --recursive --exclude "*" --include "*.json"
...
aws s3 cp KRvideos.csv s3://youtube-data-analysis-raw-useast1/youtube/raw_statistics/region=kr/
aws s3 cp MXvideos.csv s3://youtube-data-analysis-raw-useast1/youtube/raw_statistics/region=mx/
aws s3 cp RUvideos.csv s3://youtube-data-analysis-raw-useast1/youtube/raw_statistics/region=ru/
aws s3 cp USvideos.csv s3://youtube-data-analysis-raw-useast1/youtube/raw_statistics/region=us/
